...
Simulador idle/tycoon de puerto pesquero en pixel art. Heredas un puerto decadente y lo conviertes en un puerto próspero: los barcos zarpan y vuelven solos, tú cobras la carga, compras flota (8 tiers, del bote al buque factoría), desbloqueas 8 caladeros hasta El Fin del Mapa y acabas vendiendo el puerto por reputación permanente. La reputación se gasta en un **árbol de legado** que sobrevive al prestigio, en la taberna fichas **patrones** con nombre, retrato y rasgo propio, y hay **20 logros** permanentes. Jugar activo también paga: las **rachas de cobro** encadenadas bonifican, hay **capturas doradas** (×3) y la **lonja se amplía sin techo** para que siempre haya algo que comprar. El pueblo del horizonte se construye con tus hitos, la lonja te hace pedidos contrarreloj y cada especie de la pescadoteca (30) da +1% de ingresos para siempre. PWA instalable: funciona offline.
